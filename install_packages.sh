...
# pdf & image packages
sudo apt-get install diffpdf eog evince imagemagick meld pdftk pdfshuffler xloadimage a2ps ps2eps ps2pdf psutils cups-pdf
...
# Useful programs
sudo apt-get install atom audacious fbreader gimp postgresql transmission-common transmission-gtk jq tmux
